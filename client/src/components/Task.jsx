  ...
  return (
    <div className="flex justify-between bg-white p-5 mb-5 shadow-md">
      ...
      <div className="flex flex-col lg:flex-row lg:items-start gap-2">
        <button className="bg-indigo-600 p-2 text-white text-sm rounded-lg flex justify-center">
          <svg
        ...
        {false ? (
          <button className="bg-sky-600 p-2 text-white uppercase font-bold text-sm rounded-lg">
            <img className="w-6" src="https://img.icons8.com/color/48/null/checked--v1.png" /> 
          </button>
        ) : (
          <button className="bg-gray-600 p-2 text-white uppercase font-bold text-sm rounded-lg">
              <img className="w-6" src="https://img.icons8.com/parakeet/48/null/close-window.png" />
          </button>
        )}

        <button className="bg-red-600 p-2 text-white uppercase font-bold text-1xl rounded-lg">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
